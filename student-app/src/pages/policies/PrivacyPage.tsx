    ...
    <div className="min-h-screen bg-slate-950 text-slate-300 p-6 md:p-12">
      <div className="max-w-4xl mx-auto glass-card p-8 rounded-2xl border border-slate-800">
        ...
        <div className="space-y-4 text-xs leading-relaxed text-slate-300">
          ...
          <p>Print Helper System ("we", "our", or "us") is committed to protecting the privacy of students and staff using our college print management portal.</p>
          
          <h2 className="text-sm font-bold text-white mt-4">1. Information We Collect</h2>
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>Personal Data:</strong> Full Name, Student Roll Number, Student Email Address.</li>
          ...
          <p>For privacy inquiries, reach us at: <code>support@printhelper.ac.in</code></p>
        </div>
      </div>
    </div>
  );
