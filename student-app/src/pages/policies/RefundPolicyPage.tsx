    ...
    <div className="min-h-screen bg-slate-950 text-slate-300 p-6 md:p-12">
      <div className="max-w-4xl mx-auto glass-card p-8 rounded-2xl border border-slate-800">
        ...
        <div className="space-y-4 text-xs leading-relaxed text-slate-300">
          ...
          <p>At SRM Smart Print System, we strive for 100% printing accuracy and student satisfaction. This policy outlines our cancellation and refund procedures:</p>
          ...
          <p>To request a refund, report the job issue at the campus counter or email support at <code>support@srmprint.ac.in</code> with your Job ID and SRM Roll Number.</p>
        </div>
      </div>
    </div>
  );
