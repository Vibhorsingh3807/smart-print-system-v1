    ...
    <div className="min-h-screen bg-slate-950 text-slate-300 p-6 md:p-12">
      <div className="max-w-4xl mx-auto glass-card p-8 rounded-2xl border border-slate-800">
        ...
        <div className="space-y-4 text-xs leading-relaxed text-slate-300">
          ...
          <p>Welcome to SRM Smart Print System. By accessing or using our print system, you agree to comply with the following terms:</p>
          
          <h2 className="text-sm font-bold text-white mt-4">1. Service Description</h2>
          <p>SRM Smart Print System facilitates cloud document submission, automated cost estimation, queue management, and print dispatch to authorized campus stationery counters at SRMIST.</p>

          <h2 className="text-sm font-bold text-white mt-4">2. User Responsibilities</h2>
          <ul className="list-disc pl-5 space-y-1">
            <li>Users must provide accurate SRM email credentials during registration.</li>
